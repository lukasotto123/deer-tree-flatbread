...
interface VendorEmployeeInformationProps {
  employee: any;
  employeeName: string;
  citizenship: string;
}

const VendorEmployeeInformation = ({ employee, employeeName, citizenship }: VendorEmployeeInformationProps) => {
  return (
    <Card>
      <CardHeader>
...
export default VendorEmployeeInformation;
