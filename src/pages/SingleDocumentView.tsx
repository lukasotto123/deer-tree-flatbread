      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Pro Mitarbeiter</p>
              <p>{docType.isPerEmployee ? "Ja" : "Nein"}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Sichere Prüfung - Frequenz</p>
              <p>{docType.checkFrequency.secure}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Sichere Prüfung - Erfordernis</p>
              <p>{docType.requiredFor.secure}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Basisprüfung - Frequenz</p>
              <p>{docType.checkFrequency.basic}</p>
            </div>
            <div className="md:col-span-2">
              <p className="text-sm text-muted-foreground">Basisprüfung - Erfordernis</p>
